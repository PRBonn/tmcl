...
def EvalAllRuns(run_nums, type_run, folderPath):
    ...
    #print("{} & {:.3f}/{:.2f} & {:.3f}/{:.2f} & {:.3f}/{:.2f} & {:.3f}/{:.2f}  \\\\ ".format(type_run, np.mean(ang_avg[0:3]), np.mean(xy_avg[0:3]), np.mean(ang_avg[3:6]), np.mean(xy_avg[3:6]), np.mean(ang_avg[6:9]), np.mean(xy_avg[6:9]), np.mean(ang_avg[9:12]), np.mean(xy_avg[9:12])))

    #return  np.mean(ang_avg[0:3]), np.mean(xy_avg[0:3]), np.mean(ang_avg[3:6]), np.mean(xy_avg[3:6]), np.mean(ang_avg[6:9]), np.mean(xy_avg[6:9]), np.mean(ang_avg[9:12]), np.mean(xy_avg[9:12])
    return ang_avg, xy_avg
