...
class GMap : public IMap2D
{
	public:
		...
		*/
		Eigen::Vector2f World2Map(Eigen::Vector2f xy);


		std::vector<Eigen::Vector2f> World2Map(std::vector<Eigen::Vector3f> xyPoints);
		...
		*/
		Eigen::Vector2f Map2World(Eigen::Vector2f uv);
